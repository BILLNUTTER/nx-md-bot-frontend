...
export default function RegisterPage() {
  ...
  async function onSubmit(values: RegisterInput) {
    ...
    try {
      ...
      setToken(data.token);
      toast({ title: "Account created!", description: "Welcome to NX-MD BOT" });
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="border-border/50">
          <CardHeader className="text-center pb-2">
            ...
            <CardDescription>Join NX-MD BOT and automate your WhatsApp</CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
